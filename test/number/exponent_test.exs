defmodule Cldr.Number.Exponent.Test do
  ...
  test "A Decimal number exponent format with precision" do
    ...
    assert {:ok, "1.23E3"} =
             MyApp.Cldr.Number.to_string(Decimal.new("1234.5678"), format: "0.00E0")

    assert {:ok, "1.235E3"} =
             MyApp.Cldr.Number.to_string(Decimal.new("1234.5678"), format: "0.000E0")

    assert {:ok, "1.23457E3"} =
             MyApp.Cldr.Number.to_string(Decimal.new("1234.5678"), format: "0.00000E0")
  end
